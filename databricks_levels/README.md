...
- Learn about RBAC (Role Based Access Controls) and Service Principals. Create a Service Principal, which is like a user/security profile for an application, within your Azure account. As of this writing, this is available through the Azure Entra ID portal >> Manage >> App registration. This creates an application object.
